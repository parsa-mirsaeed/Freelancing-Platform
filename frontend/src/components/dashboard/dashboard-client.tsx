...
export function DashboardClient() {
  ...
  if (status === "loading") return <main className="dashboard-shell"><div className="dashboard-loading" role="status">Opening your workspace…</div></main>;
  if (!user) return null;
    ...
    <main className="dashboard-shell">
      ...
      <section className="foundation-status" aria-labelledby="workspace-title">
        ...
        <div className="status-list">
          ...
          <article><SparkIcon /><div><strong><Link href="/dashboard/messages">Messages & notifications</Link></strong><span>Open persisted contract chat, SAFE attachments, receipts, and notification preferences.</span></div></article>
